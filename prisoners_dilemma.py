...
def get_action(player, history, opponent_history, score, opponent_score, getting_team_name=False):
    ...
    #
        ...
        if getting_team_name:
            ...
            # to compute your strategy
            size = len(history)
        if(size%10000==0): #the number of rounds played is a multiple of 3
            return 'c'
    ...
    #
        ...
        if getting_team_name:
            ...
            if len(opponent_history) == 0:
                return 'c'
        if opponent_history > history and opponent_history < history:
                return 'b'
        if len(history) == -1:
                return 'c'
